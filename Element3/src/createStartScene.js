...
export function createTerrain(scene) {
    ...
    largeGroundMat.diffuseTexture = new BABYLON.Texture("./assets/textures/waterbump.png", scene);
    const largeGround = BABYLON.MeshBuilder.CreateGroundFromHeightMap("largeGround", "./assets/textures/waterbump.png", {
        width: 150,
        height: 150,
        subdivisions: 20,
        minHeight: 0,
    ...
    largeGround.position.y = -1.5;
    return largeGround;
}
function createGround(scene) {
    const groundMaterial = new BABYLON.StandardMaterial("groundMaterial", scene);
    groundMaterial.diffuseTexture = new BABYLON.Texture("./assets/textures/sand.jpg", scene);
