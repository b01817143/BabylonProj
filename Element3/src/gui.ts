...
// Type-only imports – no JS output, just IntelliSense
...
let text1!: TextBlock; // receives external messages
let text2!: TextBlock;
let text3!: TextBlock;
let text4!: TextBlock;
let heading1!: TextBlock;
...
function createTextBlock(
  ...
  // Use Control alignment constants from BABYLON.GUI
...
export function gui(scene: Scene): void {
  ...
  scene.registerBeforeRender(() => {
    // Example of how to read external data later if needed:
