...
import { Scene, ArcRotateCamera, AssetsManager, Vector3, HemisphericLight, MeshBuilder, Texture, StandardMaterial, CubeTexture, Color3, } from "@babylonjs/core";
...
function createGround(scene) {
    ...
    groundMaterial.diffuseTexture = new Texture("./assets/environments/playergrass.png");
...
function addAssets(scene) {
    ...
    const tree2 = assetsManager.addMeshTask("tree1 task", "", "./assets/nature/gltf/", "CommonTree_2.gltf");
    ...
    const tree3 = assetsManager.addMeshTask("tree1 task", "", "./assets/nature/gltf/", "CommonTree_3.gltf");
