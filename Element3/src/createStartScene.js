...
export function createTerrain(scene) {
    ...
    largeGroundMat.diffuseTexture = new Texture("./assets/textures/waterbump.png", scene);
    const largeGround = MeshBuilder.CreateGroundFromHeightMap("largeGround", "./assets/textures/waterbump.png", {
        width: 150,
        height: 150,
        subdivisions: 20,
        minHeight: 0,
